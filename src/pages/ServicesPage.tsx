...
const ServicesPage = () => {
  return (<>
    ...
    <SectionFour title="Advanced App Features" description="Enjoy Advanced App Features with our Smart App!" image="https://ca.govee.com/cdn/shop/products/H705A-PP-06_1400x.jpg?v=1689083055" left={true} right={false} />
    <Table />
